    ...
    def test_compute_transistion_matrix(self):
        ...
        npt.assert_almost_equal(
            ...
            np.linalg.inv(np.block(
                [[-np.identity(2)/3.43, np.zeros((2, 2)), np.zeros((2, 2)),
                  np.zeros((2, 2)), np.zeros((2, 2)), np.zeros((2, 2)),
                  np.zeros((2, 2)), np.zeros((2, 2))],
                 [(1-0.0955)*np.identity(2)/3.43, -np.identity(2)/2.57,
                  np.zeros((2, 2)), np.zeros((2, 2)), np.zeros((2, 2)),
                  np.zeros((2, 2)), np.zeros((2, 2)), np.zeros((2, 2))],
                 [np.zeros((2, 2)), 0.658*np.identity(2)/2.57,
                  -np.identity(2)/10, np.zeros((2, 2)), np.zeros((2, 2)),
                  np.zeros((2, 2)), np.zeros((2, 2)), np.zeros((2, 2))],
                 [np.zeros((2, 2)), (1-0.658)*np.identity(2)/2.57,
                  np.zeros((2, 2)), -np.identity(2), np.zeros((2, 2)),
                  np.zeros((2, 2)), np.zeros((2, 2)), np.zeros((2, 2))],
                 [0.0955*np.identity(2)/3.43, np.zeros((2, 2)),
                  np.zeros((2, 2)), np.zeros((2, 2)), -np.identity(2)/2.57,
                  np.zeros((2, 2)), np.zeros((2, 2)), np.zeros((2, 2))],
                 [np.zeros((2, 2)), np.zeros((2, 2)), np.zeros((2, 2)),
                  np.zeros((2, 2)), 0.658*np.identity(2)/2.57,
                  -np.identity(2)/10, np.zeros((2, 2)), np.zeros((2, 2))],
